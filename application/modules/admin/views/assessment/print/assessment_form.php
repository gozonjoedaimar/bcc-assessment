			...
			<table class="sec">
				<tbody>
					...
					<tr>
						...
						<td><span class="border-bottom print-block"><?php echo "{$form_data['course_code']} {$form_data['year_level']}"; ?></span></td>
						<td class="cell-fit"><label>ID No.:</label></td>
						<td><span class="border-bottom print-block"><?php echo "{$form_data['student_id']}"; ?></span></td>
					</tr>
				</tbody>
			</table>
		</div>
