...
<div class="box gc-container">
    <div class="box-header">
        <h4 class="box-title"><?php echo $subject_plural; ?></h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-flat" data-dismiss="modal"><?php echo $this->l('form_cancel'); ?></button>
                <button type="button" class="btn btn-danger delete-confirmation-button btn-flat"><?php echo $this->l('list_delete'); ?></button>
            </div>
        </div>
    </div>
</div>
