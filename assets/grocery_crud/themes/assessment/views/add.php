<?php
    ...
    if ($this->config->environment == 'production') {
        ...
        $this->set_js_config($this->default_theme_path.'/assessment/js/form/add.min.js');
    } else {
        $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
        ...
        $this->set_js_config($this->default_theme_path.'/assessment/js/form/add.js');
    }
...
<div class="crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="box  gc-container">
        <div class="box-header">
            <h4 class="box-title"><?php echo $this->l('form_add'); ?> <?php echo $subject?></h4>
            <div class="box-tools">
